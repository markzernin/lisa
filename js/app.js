 ...
 */
            !function(t, e) {
                ...
                }, e = "lgContainerResize", i = "lgSlideItemLoad", o = "lgBeforeSlide", n = "lgAfterSlide", s = {
                    relativeCaption: !1
                };
                return function() {
                    function l(e) {
                        ...
                        return this.core.settings = t(t({}, this.core.settings), i), this.settings = t(t(t({}, s), this.core.settings), i), 
                        this;
                    }
                    return l.prototype.init = function() {
                        var t = this;
                        this.settings.relativeCaption && (this.core.LGel.on(i + ".caption", (function(e) {
                            var i = e.detail, o = i.index, n = i.delay;
                            setTimeout((function() {
                        ...
                        var o = this.core.getSlideItem(t).find(".lg-relative-caption-item"), n = this.core.getSlideItem(t).find(".lg-sub-html");
                        n.css("width", e.width + "px").css("left", e.left + "px");
                        var s = o.get().getBoundingClientRect(), l = i.bottom - e.bottom - s.height;
                        ...
                        if (e.hasClass("lg-current")) {
                            var i = this.core.getSlideItem(t).find(".lg-object").get().getBoundingClientRect(), o = this.core.getSlideItem(t).get().getBoundingClientRect();
...
***************************************************************************** */
        ...
        var lg_relative_caption_min = __webpack_require__(997);
            ...
            galleries.forEach((gallery => {
                galleyItems.push({
                    ...
                    galleryClass: lightgallery_es5(gallery, {
                        plugins: [ lg_zoom_min, lg_fullscreen_min, lg_thumbnail_min, lg_relative_caption_min ],
